...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Add New FAQ</h3>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <select class="custom-select form-control" name="categories_id">
                                ...
                                <option value="{{$cat->id}}" {{($cat->id == old('categories_id')) ? 'selected' : ''}}>{{$cat->title}}</option>
                                @endforeach
                            </select>
                            <span class="form-text text-muted">Please select category</span>
                            @if ($errors->has('categories_id'))
                            <div style="display: block;" id="email-error" class="error invalid-feedback">{{ $errors->first('categories_id') }}</div>
                            @endif
                        </div>
