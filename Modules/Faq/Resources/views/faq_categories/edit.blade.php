...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Category Edit</h3>
<!--            <span class="kt-subheader__separator kt-subheader__separator--v"></span>-->

        </div>
        <div class="kt-subheader__toolbar">
            <a href="{{route('faqs_category.index')}}" class="btn btn-default btn-bold"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
</div>
<!-- end:: Content Head -->
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body">
            <form method="POST" enctype="multipart/form-data" action="{{route('faqs_category.store')}}" class="kt-form kt-form--label-right" _lpchecked="1">
                @csrf
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Title:</label>
                            <input type="text" class="form-control" placeholder="Enter category name" name="title" value="{{ (isset($editdata) && $editdata->title) ? $editdata->title : old('title') }}">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="description">{{ (isset($editdata) && $editdata->title) ? $editdata->title : old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <a href="{{route('faqs_category.index')}}" class="btn btn-secondary">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
