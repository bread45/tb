...
@section('title', 'General Settings List')
@section('content')
...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">General Settings List</h3>
            <!--<span class="kt-subheader__separator kt-subheader__separator--v"></span>-->
        </div>
        <div class="kt-subheader__toolbar">
            <a href="{{route('general_setting.create')}}" class="btn btn-primary btn-bold"><i class="fa fa-plus"></i> Add New</a>
        </div>
    </div>
</div>
<!-- end:: Content Head -->
...
$(function () {
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('general_setting.getall') }}",
        language: {
 oPaginate: {
   ...
   sLast: '<i class="fa fa-step-forward"></i>'
        ...
        columns: [
            ...
            {data: 'attr_key', name: 'attr_key'},
            {data: 'attr_value', name: 'attr_value'},
    ...
    $(document).on('change', '.order_by', function () {
        ...
        var order = $(this).val();
        $.ajax({
            url: "{{route('general_setting.order')}}",
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
                "id": id,
