...
<!--            <span class="kt-subheader__separator kt-subheader__separator--v"></span>-->
        ...
        <div class="kt-subheader__toolbar">
            <a href="{{route('blogs_category.index')}}" class="btn btn-default btn-bold"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
</div>
<!-- end:: Content Head -->
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body">
            <form method="POST" enctype="multipart/form-data" action="{{route('blogs_category.store')}}" class="kt-form kt-form--label-right" _lpchecked="1">
                @csrf
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <a href="{{route('blogs_category.index')}}" class="btn btn-secondary">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
