...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Settings Pages</h3>
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('general_setting.store')}}" class="kt-form kt-form--label-right" _lpchecked="1">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Key :</label>
                            <input type="text" class="form-control" placeholder="Enter Key" name="attr_key" value="{{ old('attr_key') }}">
                        ...
                        <div class="col-lg-6">
                            <label>Value:</label>
                            <textarea name="attr_value" class="form-control">{{ old('attr_value') }}</textarea>
