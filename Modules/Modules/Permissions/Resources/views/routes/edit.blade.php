                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Route name" name="route_name" value="{{ isset($editdata) ? $editdata->route_name : old('route_name') }}">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control" name="module_id" id="">
                                ...
                                <option @if(isset($editdata) ? $editdata->module_id : old('module_id')==$value->id) selected @endif value="{{$value->id}}">{{$value->name}}</option>
                                @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Label:</label>
                            <input type="text" class="form-control" placeholder="Enter Label" name="label" value="{{ isset($editdata) ? $editdata->label : old('label') }}">
