...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Routes Module</h3>
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body">
            <form method="POST" enctype="multipart/form-data" action="{{route('sliderimage.store')}}" class="kt-form kt-form--label-right" _lpchecked="1">
                @csrf
                <input type="hidden" name="slider_image_id" value="{{$editdata->id}}"/>
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Image Name:</label>
                            <input type="text" class="form-control" placeholder="Enter Route name" name="name" value="{{ isset($editdata) ? $editdata->name : old('name') }}">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control" name="slider_id" id="">
                                ...
                                <option @if($editdata->slider_id==$value->id) selected @endif value="{{$value->id}}">{{$value->name}}</option>
                                @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <textarea name="description" class="form-control">{{ isset($editdata) ? $editdata->description : old('description') }}</textarea>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <a href="{{route('sliderimage.index')}}" class="btn btn-secondary">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
