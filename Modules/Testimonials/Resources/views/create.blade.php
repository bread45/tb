                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter name" name="position" value="{{ old('position') }}">
                    ...
                    <div class="col-lg-6">
                            ...
                            <input type="file" class="form-control" placeholder="Enter name" name="user_image" accept=".png,.jpg,.jpeg" />
                            <span>Image must be in (jpeg,png,jpg) format. Maximum image size 2GB.</span>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="hidden" name="rating" class="form-control" id="rating" value="0" /> 
