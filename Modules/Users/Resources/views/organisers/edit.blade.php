...
<!--                        <div class="col-lg-6 is_sponsored_div">
                            ...
                            <div class="kt-radio-inline">
                                <label class="kt-radio kt-radio--solid">
                                    <input type="radio" name="is_subscription" @if(isset($editdata) && $editdata->is_subscription==0) checked="" @endif  value="0"> Waived
                                    <span></span>
                                </label>
                                <label class="kt-radio kt-radio--solid">
                                    <input type="radio" name="is_subscription" @if(isset($editdata) && $editdata->is_subscription==1) checked="" @endif value="1"> Regular
                                    <span></span>
                                </label>
                            </div>
                            @if ($errors->has('is_subscription'))
                            <div style="display: block;" id="email-error" class="error invalid-feedback">{{ $errors->first('is_subscription') }}</div>
                            @endif
                            </div>
                        </div>
