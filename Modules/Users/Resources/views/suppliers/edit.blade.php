...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Edit Suppliers</h3>
                                    ...
                                    <div class="tab-pane" id="spotlight" role="tabpanel">
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                        ...
                                                        <textarea name="spot_description" class="form-control ckeditor" id="">{{ (isset($editdata) && $editdata->spot_description) ? $editdata->spot_description : old('spot_description') }}</textarea>
