                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" placeholder="Please enter your subcription name" name="name" value="{{ old('name') }}">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Price:</label>
                            <input type="text" class="form-control amount" placeholder="Please enter your price" name="price" value="{{ old('price') }}">
