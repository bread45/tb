                    ...
                    <tr>
                        <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                            ...
                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                <h5>Your profile verify successfully.</h5>
                                Your registered email-id is {{$user['email']}},
                                <br> Please click on the below link to login your account.
                            </p>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                        <tr>
                                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                <a href="{{ env('FRONT_URL', 'http://192.249.121.94/~team2/eventmenow/#/')}}signin" class="button button-blue" target="_blank" style="
                                ...
                                <tr>
                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">If you having trouble.
                                            ...
                                            <a href="{{ env('FRONT_URL', 'http://192.249.121.94/~team2/eventmenow/#/')}}signin" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">
                                                {{ env('FRONT_URL', 'http://192.249.121.94/~team2/eventmenow/#/')}}signin
                                            </a>
                                        </p>
                                    </td>
                                </tr>
