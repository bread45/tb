                            ...
                            <div class="block-inner">
                                ...
                                <form class="form" method="POST" action="{{route('front.register')}}" name="register" onsubmit="return validateform()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="business_name" id="bname-input" placeholder="enter your business name"  value="{{old('business_name')}}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password" id="password-input" placeholder="enter your password" required="" minlength="8"  value="{{old('password')}}" />
                                    ...
                                    @endif  -->
                                    <button type="submit" class="btn btn-info btn-lg mb-3 width_100">Register</button>
                                </form>
