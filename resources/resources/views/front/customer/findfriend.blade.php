        ...
        <div class="banner-content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a >Find Friends</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-8 col-sm-12">
                            <div class="form-group search-group mb-2">
                                <input type="text" name="keyword" id="keyword" class="form-control search-control" placeholder="Search Name" value="" />
                            </div>
...
<script>
    ...
    function getfrienddata() {
        $.ajax({
            type: 'POST',
            url: '{{route("customer.findfriendsdata")}}?page={{$page}}',
            data: $('.searchform').serialize(),
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
