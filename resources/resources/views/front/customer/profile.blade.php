                        ...
                        <div class="profile-sidebar"> 
                            ...
                            <div class="profile-usermenu tabbable tabs-left">
                                <ul class="nav nav-tabs">
                                    ...
                                    @if(Auth::guard('front_auth')->user()->id == $user->id)
                                    <li><a href="#notification" data-toggle="tab" >Notifications ({{$notificationdata->count()}})</a></li>
                                    @endif
                                    <li><a href="#Friend" data-toggle="tab" onclick="getfrienddata()">Friends (<?php echo DB::table('messages')->where(["status" => 'unread', "to_id" => $user->id])->count()?>)</a></li>
                                    @if(Auth::guard('front_auth')->user()->id == $user->id)
