                            ...
                            <div class="service-info-jhj">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="hidden" class="form-control" name="trainerid" id="trainerid"  value="{{$trainer->id}}"> 
                                        ...
                                        <label for="date-input">Effective From</label>
                                        <input type="text" class="form-control" name="start_date" id="start_date" placeholder="enter effective from" autocomplete="off" value="{{old("start_date")}}" required>
...
$('body').removeClass('loaded');
    ...
    //alert('456');
     $.ajax({
            url: '{{ route('createmonthlyyearlrpaymentintent') }}',
            'type': 'POST',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
