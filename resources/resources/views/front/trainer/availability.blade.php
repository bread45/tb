            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="page-title d-flex align-items-center justify-content-between mb-lg-4 mb-3 pb-lg-3 flex-wrap">
                        ...
                        <h1 class="h3 text-muted font-weight-normal mb-0 mt-lg-0 mt-3 order-lg-0 order-2">My Schedule</h1>
                                        ...
                                        <div class="p-lg-5">
                                          ...
                                          @csrf
                                            ...
                                            <div class="col-lg-12 d-flex justify-content-center mb-1">
                                              ...
                                              <div class="col-lg-12 d-flex justify-content-center mb-1">
                                              <a href="{{ route('trainer.scheduling') }}"><input type="button" value="Reset" class="btn bg-transparent" /></a>
                                            </div>
                                          </form>
