                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="form-row add-resource-form" method="POST" action="{{route('resource.store')}}" enctype='multipart/form-data'>
                                        ...
                                        <input type="hidden" name="resource_image_path" id="resource_image_path">
                                        <input type="hidden" name="resource_video_path" id="resource_video_path">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="edit-img">
                                                ...
                                                <img id="show_image" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/resource/'.$trainerResource->format_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif " alt="Yoga">
                                                   
                                            @endif
                                            @if($trainerResource->format == 'Article')
                                                <img id="show_image" src="@if(isset($trainerResource->image_name) && !empty($trainerResource->image_name)) {{ asset('front/images/resource/'.$trainerResource->image_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif " alt="Yoga">
                                            ...
                                            @if($trainerResource->format == 'EBook')
                                                <img id="show_image" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/document.jpg')}} @else {{ asset('front/images/service_placeholder.png')}}  @endif " alt="Yoga">
                                            ...
                                            @if($trainerResource->format == 'Video')
                                               @if($trainerResource->type == '1')
                                                    <img id="show_image" src="@if(isset($trainerResource->image_name) && !empty($trainerResource->image_name)) {{ asset('front/images/resource/'.$trainerResource->image_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif " alt="Yoga">
                                                      <a href="#" data-toggle="modal" data-target="#resource_details{{$trainerResource->id}}" id="imgPopup">View Video</a>
                                        ...
                                        <div class="form-group col-lg-6" id="video-url">
                                            ...
                                            <input type="text" class="form-control saas" name="url" id="url-input" required placeholder="enter video url" value="@if(isset($trainerResource->format_name))@if($trainerResource->type==1){{ $trainerResource->format_name }} @endif @endif">
                                            @if ($errors->has('url'))
                                        ...
                                        <div class="form-group col-lg-6" id="video-url" style="display:none">
                                            <!--<label for="name-input">URl</label> <br />-->
                                            <div class="form-check form-check-inline">
                                              <input class="form-check-input videoType" type="radio" name="videoType" id="videofileUrl" value="1" @if(isset($trainerResource->type))@if($trainerResource->type==1) checked @else @endif @endif>
                                              <label class="form-check-label" for="videoCheckbox1">Cloud URL</label>
                                        ...
                                        @endif
                                        @if(isset($trainerResource->format))
                                        <div class="form-group col-lg-6" id="upload_image_show">
                                        ...
                                        <div class="form-group col-lg-12">
                                            <label for="massage-input">Body content </label>
                                        ...
                                        <div class="col-lg-12 d-flex justify-content-center mb-1">
                                            <input type="submit" value="Publish" class="btn btn-danger btn-lg" style="margin-right:5px;" />
                                            </div>
                                            <div class="col-lg-12 d-flex justify-content-center mb-1">
        ...
        <section class="pt-4 no_padding">
          <div class="container">
            <div class="row justify-content-center">
              ...
              @if(isset($trainerResource->format)) 
                @if($trainerResource->format == 'Image')
                    <img class="img-fluid position_relative" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/resource/'.$trainerResource->format_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="...">
                @endif
                @if($trainerResource->format == 'Video')
                    <a href="#" id="resource_url_perview" data-toggle="modal" data-target="#resource_details{{$trainerResource->id}}" id="imgPopup"><img class="img-fluid position_relative" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/resource/'.$trainerResource->image_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="..."></a>
                    <img class="add-img-fluid position_relative" style="display:none;" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/resource/'.$trainerResource->format_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="...">
                @endif  
                @if($trainerResource->format == 'Article')
                    <a href="#" id="resource_url_perview" style="display:none;" data-toggle="modal" data-target="#resource_details{{$trainerResource->id}}" id="imgPopup"><img class="img-fluid position_relative" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/resource/'.$trainerResource->image_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="..."></a>
                     <img class="add-img-fluid position_relative" src="@if(isset($trainerResource->image_name) && !empty($trainerResource->image_name)) {{ asset('front/images/resource/'.$trainerResource->image_name)}} @else {{ asset('front/images/service_placeholder.png')}} @endif" alt="...">
                @endif 
                @if($trainerResource->format == 'EBook')
                    <a href="{{ asset('front/images/resource/'.$trainerResource->format_name)}}" target="_blank" id="resource_url_perview"><img class="img-fluid position_relative" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/document.jpg')}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="..."></a>
                @endif

              @else
              <a id="resource_url_perview" data-toggle="modal" data-target="#perview_resource_details" id="imgPopup"><img class="img-fluid position_relative" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/resource/'.$trainerResource->format_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="..."></a>
              <img class="add-img-fluid position_relative" src="@if(isset($trainerResource->format_name) && !empty($trainerResource->format_name)) {{ asset('front/images/resource/'.$trainerResource->format_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="...">
              @endif
...
@if(isset($trainerResource->format))
         <div class="modal fade" id="resource_details{{$trainerResource->id}}" tabindex="-1" role="dialog" aria-labelledby="likes" aria-hidden="true">
                    ...
                    <div class="modal fade" id="perview_resource_details" tabindex="-1" role="dialog" aria-labelledby="likes" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
