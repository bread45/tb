                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea rows="10" class="form-control ckeditor" placeholder="Please enter next steps modal content" id="message-input" name="steps_modal_content">{{ old('steps_modal_content') }}</textarea> 
                            <!-- <span class="form-text text-muted">Please enter your subcription plan</span> -->
