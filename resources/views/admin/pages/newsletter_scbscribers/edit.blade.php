                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea rows="10" class="form-control ckeditor" placeholder="Please enter next steps modal content" id="message-input" name="steps_modal_content">{{ isset($NextSteps) ? $NextSteps->modal_content : old('steps_modal_content') }}</textarea> 
                            <!-- <span class="form-text text-muted">Please enter your subcription plan</span> -->
                            @if ($errors->has('steps_modal_content'))
                            <div style="display: block;" id="title-error" class="error invalid-feedback">{{ $errors->first('steps_modal_content') }}</div>
                            @endif
                        </div>
                    </div>
