        ...
        <div class="col-lg-6 pr-lg-6 col-md-auto mb-lg-0 mb-5 bg_first">
          ...
          <div class="block-inner ">
            ...
            <div>
              ...
              <p class="text-center sub_title_1">New to Training Block? <br><a href="{{route('register')}}"> Athlete Sign Up</a> 
          ...
          <div class="row">
            ...
            <form class="form" method="POST" action="{{ route('front.loggedIn') }}">
				...
				<input type="hidden" name="prevUrl" value="<?php echo URL::previous(); ?>" />
            ...
            <button type="submit" class="btn btn-info btn-lg mb-3 btn-center">Login</button>
              ...
              <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  <a href="{{route('front.password.reset')}}"
                    class="btn pull-right lostposs">Lost Your Password?</a>
                </div>
              </div>
