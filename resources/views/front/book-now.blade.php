            ...
            <div class="row">
                ...
                @if (session('message'))
                 ...
                 @endif
                        ...
                        <form method="POST" action="{{route('createzeropaymentsave')}}" class="require-validation mb-lg-5" id="zero-prize-submit">
                        @endif
                            @csrf
     ...
     $.ajax({
            ...
            success: function (result) {
                if (result.status == true) {
                     ...
                     console.log(clientcreactkey);
                     //var stripeCofirm = Stripe('pk_test_fqBedhauV53FOkek7Wu43eMS00qeYeph7j'); 
