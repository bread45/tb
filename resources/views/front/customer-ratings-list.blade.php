            ...
            <div class="common-data-table table-responsive">
                ...
                <table id="myTable" class="display nowrap " style="width:100%">
                    ...
                    @foreach($ratings as $key => $rating)
                        ...
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td style="width: 10%;">{{ date('m-d-Y', strtotime($rating->created_at)) }}</td>
                            <td>
...
@stop
@section('pagescript')
<link rel="stylesheet" type="text/css" href="http://trainingblock.sgsuat.info/public/front/trainer/css/responsive.css" />
<style>
table{
  margin: 0 auto;
  width: 100%;
