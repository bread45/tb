            ...
            <div class="register-block-inner">
                ...
                <form class="form-row"  method="POST" action="{{route('customer.change_password')}}#change_password" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input type="password" class="form-control" name="password" id="password-input" placeholder="enter your new password" value="" required="" minlength="8" onChange="validatePassword()">
