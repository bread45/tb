                    ...
                    <div class="card-body profile-details d-md-flex justify-content-between">
                        ...
                        <div class="profile_main d-sm-flex">
                            <div class="profile-img">
                                <img src="@if(isset($user->photo) && !empty($user->photo)) {{ asset('front/profile/'.$user->photo)}} @else {{ asset('/front/images/details_default.png')}}  @endif " alt=""/>
                            </div> 
...
<!--                                    <i class="fas fa-tag"></i>-->
                        ...
                        <div class="profile_right">
                            <ul class="nav profile-nav">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{route('customer.profile')}}"><i class="fas fa-user-edit"></i> Update Profile</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{route('customer.findfriends')}}"><i class="fas fa-hand-point-right"></i> Find Friends</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="javascript:void(0)"><i class="fas fa-user-friends"></i>Invite Friends</a>
                                </li>
                                <!--                                <li class="nav-item">
                        ...
                        <div class="profile-sidebar"> 
                            ...
                            <div class="profile-usermenu tabbable tabs-left">
                                <ul class="nav nav-tabs">
                                    ...
                                    @endif
                                    <li><a href="#Friend" data-toggle="tab" onclick="getfrienddata()">Friends</a></li>
                                    @if(Auth::guard('front_auth')->user()->id == $user->id)
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                                                        ...
                                                                                        <div class="about-content"><?php echo $user->bio;  ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="media" id="addrecommended_id_{{$Trainer->users->id}}">
                                        <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" style="object-fit: cover;" src="@if(isset($Trainer->users->photo) && !empty($Trainer->users->photo) && file_exists(public_path('front/profile/'.$Trainer->users->photo))) {{ asset('front/profile/'.$Trainer->users->photo)}} @else {{ asset('/front/images/details_default.png')}}  @endif" />
                                        <div class="media-body">
