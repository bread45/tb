            ...
            <div class="row">
                ...
                @if (session('message'))
                 ...
                 @endif
                        ...
                        <form method="POST" action="{{route('createmonthlyyearlypaymentsave')}}" class="require-validation mb-lg-5"
                            ...
                            <div class="service-info-jhj">
                                ...
                                <div class="form_row">
                                    <div class="form-group mb-4 row">
                                        <label for="service-input" class="col-md-4 col-form-label">Service Name</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group mb-4 row">
                                     ...
                                     <div class="form-group mb-4 row">
                                        ...
                                        ?>
                                        <label for="service-category-input" class="col-md-4 col-form-label">Provider Business Name</label>
                                        <div class="col-sm-8">
                                   ...
                                   <!-- <div class="form-group mb-4 col-lg-6">
                                    ...
                                    <div class="form-group mb-4 row">
                                        ...
                                        <label for="service-price-input" class="col-md-4 col-form-label">Service Price $ </label>
                                        <div class="col-sm-8">
