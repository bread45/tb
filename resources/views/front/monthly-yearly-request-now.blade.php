            ...
            <div class="row">
                ...
                @if (session('message'))
                 ...
                 @endif
                        ...
                        <form method="POST" action="{{route('requestmonthlyyearlrpaymentintent')}}" class="require-validation mb-lg-5"
                            ...
                            <div class="service-info-jhj">
                                ...
                                <div class="form_row">
                                    <div class="form-group mb-4 row">
                                        ...
                                        <label class="col-md-4 col-form-label" for="service-input">Service Name</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group mb-4 row">
                                        <label for="service-input" class="col-md-4 col-form-label">Service Type</label>
                                        <div class="col-sm-8">
                                        <input type="text" class="form-control" name="service_format" value="{{$services->format}}" readonly>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group mb-4 row">
                                        ...
                                        ?>
                                        <label class="col-md-4 col-form-label" for="service-category-input">Provider Business Name</label>
                                        <div class="col-sm-8">
                                   ...
                                   <!-- <div class="form-group mb-4 row">
                                        ...
                                        <label class="col-md-4 col-form-label" for="service-type-input">Service Type</label>
                                    ...
                                    <input type="hidden" class="form-control" name="plan_type" id="plan_type" value="{{$services->format}}">
                                        ...
                                        <div class="col-sm-8">
                                        <input type="text" class="form-control" name="start_date" id="start_date" placeholder="enter start date" autocomplete="off" value="{{old("start_date")}}" required>
                                    ...
                                    <?php if($services->format == 'In person - Monthly Membership' || $services->format == 'Virtual - Monthly Membership'){
                                        $service_format = 'monthly';
                                    } else {
                                        $service_format = 'yearly';
                                    
                                    }?>

                                    <div class="form-group mb-4 row">
                                        
                                        <label class="col-md-4 col-form-label" for="service-price-input">Service Price $ </label>
                                        <div class="col-sm-8">
                                        <input type="text" class="form-control membership_price" name="service_amount" id="amount-input" value="{{ $services->price }}" readonly>
                                        <?php if($services->format == 'In person - Yearly Membership' || $services->format == 'Virtual - Yearly Membership'){
                                        $service1_format = 'annually';
                                        }
                                        else {
                                            $service1_format = 'monthly';
                                        }
                                        ?>
                                        <span class="recurring_label">recurring {{$service1_format}}</span>
                                        </div>
                                       
                                    </div>

                                     <div class="form-group mb-4 col-lg-12" id="is_recurring">
                                    
                                     <p>This is a <?php echo $service_format;?> subscription, which creates a recurring charge to your credit card. If you need to cancel at any point in the future, please do so within your Order History tab.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group mb-0 col-lg-12 book-now-btn">
                                        <button class="btn btn-danger" type="submit">REQUEST TO BOOK</button>
                                    </div>
                                </div>
...
$(function() {
 ...
 $.ajax({
            url: '{{ route('createmonthlyyearlypaymentsave') }}',
            'type': 'POST',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
