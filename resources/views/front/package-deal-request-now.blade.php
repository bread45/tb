            ...
            <div class="row">
                ...
                @if (session('message'))
                 ...
                 @endif
                        ...
                        <form method="POST" action="{{route('requestpackagedealpaymentintent')}}" class="require-validation mb-lg-5"
                        ...
                        <form method="POST" action="{{route('requestpackagedealzeropaymentintent')}}" class="require-validation mb-lg-5" id="zero-prize-submit">
                        @endif
                            @csrf
