...
<section class="inner-banner-section bg-primary">
    ...
    <section class="customer-info-section">
        ...
        <div class="row">
            ...
            <a style="float:right;background-color: #00ab91;" class="btn btn-primary btn-sm" href="{{url()->previous()}}">Back</a>
            </div>
        </div>
            <div class="row">
                ...
                @if (session('message'))
                 ...
                 @endif
                        ...
                        <form method="POST" action="{{route('requestpaymentsave')}}" class="require-validation mb-lg-5"
                        ...
                        <form method="POST" action="{{route('requestzeropaymentsave')}}" class="require-validation mb-lg-5" id="zero-prize-submit">
                        @endif
                            @csrf
                            ...
                            <div class="payment-form">
                                ...
                                <div class='form-row row invaild-card' style="display:none;">
...
$(function() {
  ...
  var orderComplete = function(customer_id) {
