                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body px-0 pb-2">
                                    ...
                                    @if (session('message'))
                                    <div class="alert alert-success seo-resource-success">
                                        {{ session('message') }}
                                    </div>
                                    @endif
                                    @if (session('error'))
                                    <div class="alert alert-danger seo-resource-success">
                                        {{ session('error') }}
                                    </div>
                                    @endif
                                    <div class="container-fluid">                           
                                                    ...
                                                    <section class="pt-4 no_padding">
                                                      <div class="container">
                                                        ...
                                                        @if($resource->format == 'Video')
                                                            ...
                                                            <a href="{{ $resource->format_name }}" target="_blank" id="resource_url_perview"><img class="img-fluid position_relative" src="@if(isset($resource->image_name) && !empty($resource->image_name)) {{ asset('front/images/resource/'.$resource->image_name)}} @else {{ asset('front/images/resource/details_default.png')}}  @endif" alt="..." style="object-fit: cover;"><div><img src="{{asset('front/images/play.png')}}" class="play_btn_resource" ></div></a></div>
                                                        @endif  
                                                        @if($resource->format == 'Article')
                                                            @if(isset($resource->big_image_name) && !empty($resource->big_image_name))
                                                                <a href="{{ asset('front/images/resource/'.$resource->big_image_name)}}" target="_blank" id="resource_url_perview"><img class="img-fluid position_relative" src="@if(isset($resource->format) && !empty($resource->format)) {{ asset('front/images/resource/'.$resource->image_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="..."></a>
                                                            @else
                                                                <a href="{{ asset('front/images/resource/'.$resource->image_name)}}" target="_blank" id="resource_url_perview"><img class="img-fluid position_relative" src="@if(isset($resource->format) && !empty($resource->format)) {{ asset('front/images/resource/'.$resource->image_name)}} @else {{ asset('front/images/service_placeholder.png')}}  @endif" alt="..."></a>
                                                            @endif
                                                        @endif 
                                                        ...
                                                        <div class="row justify-content-center">
                                                          <div class="col-12 col-md-10">
                                                            ...
                                                            <p style="text-align:justify"><span style="font-size:11pt"><span style="font-family:Arial"><span
                                                                    style="color:#000000">{!! $resource->description !!}</span></span></span></p>
...
//        });
    ...
    var table = $('#resource-table').DataTable({
                ...
                language: {
                    ...
                    "sEmptyTable":     "You have added no resources to your account"
                },
                "order": [[ 0, "asc" ]],
