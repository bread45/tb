            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="page-title d-flex align-items-center justify-content-between mb-lg-4 mb-3 pb-lg-3 flex-wrap">
                        ...
                        <h1 class="h3 text-muted font-weight-normal mb-0 mt-lg-0 mt-3 order-lg-0 order-3">Memberships & Packages</h1>
                    ...
                    Review the memberships & packages subscriptions that have been purchased by athletes
                    </div>
                    </div>
                                        ...
                                        <div class="p-lg-5">
                                          ...
                                          @csrf
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                              ...
                                              <option value="In person - Monthly Membership" @if($package_type == 'In person - Monthly Membership') selected @endif>In person - Monthly Membership</option>
                                              <option value="In person - Yearly Membership" @if($package_type == 'In person - Yearly Membership') selected @endif>In person - Yearly Membership</option>
                                              <option value="In person - Package Deal" @if($package_type == 'In person - Package Deal') selected @endif>In person - Package Deal</option>
                                              <option value="Virtual - Monthly Membership" @if($package_type == 'Virtual - Monthly Membership') selected @endif>Virtual - Monthly Membership</option>
                                              <option value="Virtual - Yearly Membership" @if($package_type == 'Virtual - Yearly Membership') selected @endif>Virtual - Yearly Membership</option>
                                              <option value="Virtual - Package Deal" @if($package_type == 'Virtual - Package Deal') selected @endif>Virtual - Package Deal</option>
                                              </select>
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                              <label for="sprice-input">Effective From</label>
                                              <input type="text" class="form-control" name="paid_date" id="paid_date" maxlength="30" placeholder="enter effective from" value="{{$paid_date}}" autocomplete="off">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <div class="col-lg-12 d-flex justify-content-center mb-1">
                                              ...
                                              <div class="col-lg-12 d-flex justify-content-center mb-1">
                                              <a href="{{ route('trainer.month.annual.schedules') }}"><input type="button" value="Reset" class="btn bg-transparent" style="color: #44859b;text-decoration: underline;"/></a>
                                            </div>
                                          </form>
                                    ...
                                    <table id="month-annual-table" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($service->amount != '0.00')
                                                        ${!! number_format((float)($service->amount), 2) !!} USD
                                                        @else
                                                        ${{$service->amount}} USD
                                                        @endif
                                                    </td>
                                                    <td>
                                                        {{ date('m-d-Y H:i:s', strtotime($service->created_at)) }}
                                                    </td>
                                                    <td>
                                                        @if($service->start_date != '0000-00-00')
                                                        {{ date('m-d-Y', strtotime($service->start_date)) }}
                                                        @endif
                                                    </td>
                                                   
                                                    @if($service->order_status == 'cancelled')
                                                         <td>Cancelled</td>
                                                        @else
