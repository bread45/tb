                ...
                <div class="container-fluid">
                    <div class="page-title d-flex align-items-center justify-content-between mb-lg-4 mb-3 pb-lg-3 flex-wrap">
                        ...
                        <div class="stripe_style">
                            <!--<img src="{{asset('images/stripe_connected.png')}}" style="width: 30px;padding-right: 5px;margin-right: 2px;margin-top: -6px;">-->Your Bank Account is Connected
                          </div>
                        @endif 

                            @if(empty($StripeAccountsdata))
                            <a href="{{ route('service.add')}}" class="btn btn-info ml-lg-auto mr-3 order-lg-1 order-4 mt-lg-0 mt-2 Seo-stripe-AddService-A">Add Service</a>
                            @else
                            <a href="{{ route('service.add')}}" class="btn btn-info ml-lg-auto mr-3 order-lg-1 order-4 mt-lg-0 mt-2 Seo-stripe-AddService-B">Add Service</a>
                            @endif
                    ...
                    List the services you offer to athletes, and add appointment booking. In order to add appointment booking, you must first connect your Training Block account with your Stripe payment account. Note that Training Block takes a 5% transaction fee for all appointments booked by an athlete through our platform.
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body px-0 pb-2">
                                    ...
                                    @if (session('message'))
                                    <div class="alert alert-success seo-service-success">
                                        {{ session('message') }}
                                    </div>
                                    @endif
                                    @if (session('error'))
                                    <div class="alert alert-danger seo-service-error">
                                        {{ session('error') }}
                                    </div>
                                    @endif
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <!--  @if($service->is_recurring == "yes")
                                                    ...
                                                    ${!! number_format((float)($service->price), 2) !!} USD
                                                    @else
                                                    {{$service->price}}
                                                    @endif
                                                   <!--  @endif  -->
